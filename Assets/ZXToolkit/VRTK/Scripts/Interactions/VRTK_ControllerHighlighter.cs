...
namespace VRTK
{
    ...
    public class VRTK_ControllerHighlighter : MonoBehaviour
    {
        ...
        public virtual string GetPathForControllerElement(SDK_BaseController.ControllerElements controllerElement)
        {
        ...
        public virtual Transform GetElementTransform(string path)
        {
